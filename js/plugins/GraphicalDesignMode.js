...
// ----------------------------------------------------------------------------
// Version
// 2.10.8 2020/06/21 Fixed a problem with the window height is less than the item height.
// 2.10.7 2020/04/29 Fixed the battle log window position when it cannot be changed
// 2.10.6 2020/03/21 Minor tweaks to SceneCustomMenu.js
// 2.10.5 2020/02/06 Fixed the position changes when canceling in design mode where windows are added with the plugin
// 2.10.4 2020/01/27 Fixed an issue where window positions added from the plugin aren't used
 ...
 * For details, refer to “User rewrite” in the source code.
...
(function() {
    'use strict';
    //=============================================================================
    // User rewrite - Start here -
    //  pictures :  Picture info displayed on each screen
    //  windows  : Window info displayed on each screen
    // (The filename specified could be excluded as an unused file during deployment)
    // ※A comma is added to the last item to make it easier to copy and paste.
    //=============================================================================
    var settings = {
        /* タイトル画面の追加情報 */
        Scene_Title   : {
    ...
    if (!Utils.RPGMAKER_VERSION || Utils.RPGMAKER_VERSION.match(/^1\.2./)) {
        alert('!!!This plugin can only be used for MV version 1.3 or later.!!!');
        return;
    }
