...
/*:
 * @target MZ MV
 * @plugindesc Show an alert when closing the game window.
 * @author Lulu's Church
 * @url https://nine-yusha.com/plugin-shutdownalert/
 *
 * @help LL_ShutdownAlert.js
 *
 * This plugin shows an alert when the window's [X] close button is clicked.
 * You can use this to prevent accidental shutdowns.
 *
 ...
 * @desc Message to display when the window close button is clicked.
